...
export const cardMentalFrameLr = "/img/card_frame_m_lr.webp"
...
export const cardActiveFrameLr = "/img/card_frame_a_lr.webp"
...
export const buffTypeBackground = {
  ...
  [ProduceExamEffectType.ExamLessonDependBlockConsumptionSum]: buffBgBlue,
  [ProduceExamEffectType.ExamForcePlayCardSearchWithCost]: buffBgRed,
  [ProduceExamEffectType.ExamBlockDependBlockConsumptionSum]: buffBgBlue,
  [ProduceExamEffectType.ExamEnthusiasticTurnAdd]: buffBgBlue,
  [ProduceExamEffectType.ExamEffectTimerEndTurn]: buffBgBlue,
  [ProduceExamEffectType.ExamStanceLockConcentration]: buffBgRed,
  [ProduceExamEffectType.ExamStanceLockFullPower]: buffBgBlue,
  [ProduceExamEffectType.ExamStanceLockPreservation]: buffBgBlue,
  [ProduceExamEffectType.ExamCardShuffleDeckGrave]: buffBgYellow,
  [ProduceExamEffectType.ExamReviewCountAdd]: buffBgBlue,
  [ProduceExamEffectType.ExamReviewTurnEndReduceLock]: buffBgBlue,
  [ProduceExamEffectType.ExamParameterBuffTurnEndReduceLock]: buffBgBlue,
  [ProduceExamEffectType.ExamBuffConsumptionDown]: buffBgBlue,
  [ProduceExamEffectType.ExamBuffConsumptionAdd]: buffBgRed,
  [ProduceExamEffectType.ExamSearchPlayCardBuffConsumptionChange]: buffBgBlue,
  [ProduceExamEffectType.ExamPlayCardLimitPlayableValueAdd]: buffBgBlue,
  [ProduceExamEffectType.ExamReviewDependReviewConsumptionSum]: buffBgBlue,
  [ProduceExamEffectType.ExamLessonBuffReduceCancellable]: buffBgBlue,
  [ProduceExamEffectType.ExamParameterBuffReduceCancellable]: buffBgBlue,
  [ProduceExamEffectType.ExamAggressiveReduceCancellable]: buffBgBlue,
  [ProduceExamEffectType.ExamReviewReduceCancellable]: buffBgBlue,
  [ProduceExamEffectType.ExamFullPowerPointReduceCancellable]: buffBgBlue,
  [ProduceExamEffectType.ExamStatusEnchantTurnAdd]: buffBgBlue,
  [ProduceExamEffectType.ExamStatusEnchantCountAdd]: buffBgBlue,
  [ProduceExamEffectType.ExamParameterBuffAdditiveFix]: buffBgBlue,
  [ProduceExamEffectType.ExamLessonBuffAdditiveFix]: buffBgBlue,
  [ProduceExamEffectType.ExamAggressiveAdditiveFix]: buffBgBlue,
  [ProduceExamEffectType.ExamReviewAdditiveFix]: buffBgBlue,
  [ProduceExamEffectType.ExamFullPowerPointAdditiveFix]: buffBgBlue,
  [ProduceExamEffectType.ExamMoveGrowEffect]: buffBgBlue,
  [ProduceExamEffectType.ExamLessonDependEnthusiasticGetSum]: buffBgBlue,
  [ProduceExamEffectType.ExamCardShuffleDeckLost]: buffBgBlue,
  [ProduceExamEffectType.ExamFullPowerPointDependFullPowerPointGetSum]: buffBgBlue,
  [ProduceExamEffectType.ExamStatusEnchantEncore]: buffBgYellow,
}
